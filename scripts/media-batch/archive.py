...
job=root/'batch-2026-09-10';state=json.loads((job/'state.json').read_text())
...
receipt.append(copy_verified(archive,drive/'Originals/Blue Archive/Batch-2026-09-10'/archive.name))
